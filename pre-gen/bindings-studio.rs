...
pub const FMOD_VERSION: u32 = 131617;
...
const _: () = {
    ...
    ["Offset of field: FMOD_ADVANCEDSETTINGS::maxPCMCodecs"]
        [::std::mem::offset_of!(FMOD_ADVANCEDSETTINGS, maxPCMCodecs) - 28usize];
    ...
    ["Offset of field: FMOD_ADVANCEDSETTINGS::maxOpusCodecs"]
        [::std::mem::offset_of!(FMOD_ADVANCEDSETTINGS, maxOpusCodecs) - 96usize];
    ["Offset of field: FMOD_ADVANCEDSETTINGS::maxSpatialObjects"]
        [::std::mem::offset_of!(FMOD_ADVANCEDSETTINGS, maxSpatialObjects) - 100usize];
};
